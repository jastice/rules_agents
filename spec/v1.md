...
This document documents the initial version of the implementation. It is now only informational and does not need to be strictly respected for further work. 
